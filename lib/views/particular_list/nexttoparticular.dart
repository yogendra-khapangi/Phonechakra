...
class NextToParticular extends StatelessWidget {
  NextToParticular({super.key});
                        ...
                        ListTile(
                          title: RichText(
                            text: TextSpan(children: [
                              TextSpan(
                                  text:
                                      "${listbyCategoriesController.onlymunicipalitylist.value.data.length}",
                        ...
                        SizedBox(
                          child: ListView.builder(
                              ...
                              itemCount: listbyCategoriesController
                                  .onlymunicipalitylist.value.data.length,
                              shrinkWrap: true,
