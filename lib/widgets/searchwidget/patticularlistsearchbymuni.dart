...
class Particularsearchbymunicipality extends StatelessWidget {
    ...
    return GetBuilder<SearchsController>(
      builder: (controller) {
        ...
        return Container(
          ...
          // Set a fixed height or use appropriate constraints
          ...
          child: Row(
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  searchController.getSearchListbymunicipality(
                  ...
                  if (AppTextEditingController.searchanything.text.isEmpty) {
                    ...
                    Get.toNamed(AppRoute.nexttopaticular, arguments: {
                      "title":
                          "$title-${AppTextEditingController.searchanything.text}"
                    });
                  }
                },
                child: const Icon(
